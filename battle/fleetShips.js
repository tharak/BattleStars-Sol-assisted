...
const WEDGE_POSITION_ORDER = Object.freeze([16, 9, 14, 8, 12, 7, 15, 18, 13, 6, 4, 0, 17, 11, 5, 2, 3, 1, 10]);
...
export function formationPositionOrder(formation = "sphere", count = 57) {
  ...
  if (formation !== "line" && formation !== "arrow" && formation !== "wedge" && formation !== "column") return positions;
  const order = formation === "line" ? LINE_POSITION_ORDER
    : formation === "arrow" ? ARROW_POSITION_ORDER
      : formation === "wedge" ? WEDGE_POSITION_ORDER : COLUMN_POSITION_ORDER;
